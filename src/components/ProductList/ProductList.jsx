...
const products = [
    ...
    {id: '175', title: 'Armatfood. Овощи печеные', price: 1, description: '', image: ''},
    {id: '176', title: 'Armatfood. Лечо', price: 1, description: '', image: ''},
    {id: '177', title: 'Armatfood. Томатная паста', price: 1, description: '', image: ''},
    {id: '178', title: 'Armatfood. Зеленый острый перец', price: 1, description: '', image: ''},
    {id: '179', title: 'Armatfood. Овощная закуска', price: 1, description: '', image: ''},
    {id: '180', title: 'Armatfood. Аджика острая', price: 1, description: '', image: ''},
    {id: '181', title: 'Armatfood. Аждика', price: 1, description: '', image: ''},
    {id: '182', title: 'Armatfood. Икра баклажановая острая "На углях"', price: 1, description: '', image: ''},
    {id: '183', title: 'Armatfood. Икра баклажановая острая', price: 1, description: '', image: ''},
    {id: '184', title: 'Armatfood. Икра баклажановая', price: 1, description: '', image: ''},
