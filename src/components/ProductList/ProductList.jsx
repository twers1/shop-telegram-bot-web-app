...
const products = [
    ...
    {id: '357', title: 'ЭкоКат. Закопанный сыр', price: 950, description: '2 вида: ', image: ''},
    {id: '358', title: 'ЭкоКат. Сыр качотта', price: 1, description: '', image: ''},
    {id: '359', title: 'ЭкоКат. Сыр фета в масле', price: 530, description: '350г', image: ''},
    {id: '360', title: 'Alashkert. Сыр', price: 1, description: '', image: ''},
    {id: '361', title: 'Арарат. Хаш домашний', price: 1, description: '', image: ''},
    {id: '362', title: 'Алагяш. Хаш', price: 380, description: '', image: ''},
    {id: '363', title: 'Кавказское застолье. Хаш', price: 1, description: '', image: ''},
    {id: '364', title: 'Marianna. Сыр чанах в рассоле', price: 840, description: '', image: ''},
    {id: '365', title: 'Апаран. Сыр чанах', price: 1, description: '', image: ''},
    {id: '366', title: 'Ереван. Чанах', price: 1, description: 'рассольный сыр', image: ''},
    {id: '367', title: 'Ереван. Мацун', price: 130, description: 'Жирность: 3.6%*4%; 900г', image: ''},
    {id: '368', title: 'Монастырьская буреночка. Мацун Армянский', price: 140, description: '900г', image: ''},
    {id: '369', title: 'Marianna. Сливки ', price: 300, description: '10%; ультрапастеризованные', image: ''},
    {id: '370', title: 'Marianna. Молоко', price: 230, description: 'ультрапастеризованное', image: ''},
    {id: '371', title: 'Гарни. Тан', price: 1, description: 'Кисломолочные напиток; 1,5%', image: ''},
    {id: '372', title: '', price: 1, description: '', image: ''},
    {id: '373', title: '', price: 1, description: '', image: ''},
    {id: '374', title: '', price: 1, description: '', image: ''},
    {id: '375', title: '', price: 1, description: '', image: ''},
    {id: '376', title: '', price: 1, description: '', image: ''},
    {id: '377', title: '', price: 1, description: '', image: ''},
    {id: '378', title: '', price: 1, description: '', image: ''},
    {id: '379', title: '', price: 1, description: '', image: ''},
    {id: '380', title: '', price: 1, description: '', image: ''},
    {id: '381', title: '', price: 1, description: '', image: ''},
    {id: '382', title: '', price: 1, description: '', image: ''},
    {id: '383', title: '', price: 1, description: '', image: ''},
    {id: '384', title: '', price: 1, description: '', image: ''},
    {id: '385', title: '', price: 1, description: '', image: ''},
    {id: '386', title: '', price: 1, description: '', image: ''},
    {id: '387', title: '', price: 1, description: '', image: ''},
    {id: '388', title: '', price: 1, description: '', image: ''},
